...
import io.cdap.plugin.hooks.TestSetupHooks;
...
public class GoogleDriveSource  {
  ...
  @Then("Validate the data transferred from GoogleDrive to BigQuery with actual And expected file for: {string}")
  public void validateTheDataFromGoogleDriveToBQWithActualAndExpectedFileFor(String expectedFile) throws IOException,
    InterruptedException, URISyntaxException {
    boolean recordsMatched = BQValidationExistingTables.validateActualDataToExpectedData(TestSetupHooks.bqTargetTable,
  ...
  @Then("Select dropdown plugin property from output schema and set the value: {string}")
  public void selectDropdownPluginPropertyFromOutputSchemaAndSetTheValue(String value) {
   GoogleDriveActions.selectSchemaOption(value);
  }
}
