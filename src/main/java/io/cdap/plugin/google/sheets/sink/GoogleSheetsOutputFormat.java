 ...
 */
public class GoogleSheetsOutputFormat extends OutputFormat<NullWritable, FlatteredRowsRecord> {
  @Override
  public RecordWriter<NullWritable, FlatteredRowsRecord> getRecordWriter(TaskAttemptContext taskAttemptContext)
    throws IOException {
